...
class SiteController extends Controller
{
     ...
     *
     * Вызов:
     *      GET <SERVER>/list-ids-rent-object
     *
     * Вход:
     *      Нет
     *
     ...
     *  ]
     */
    public function actionListIdsRentObject()
    {
     ...
     *  ]
     */
    public function actionCountRentObject()
    {
        Yii::$app->response->format = Response::FORMAT_JSON;

        return ON::countRentObject();
    }
